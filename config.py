...
OWNER_USERNAME = getenv("OWNER_USERNAME", "JUST_ME_NOBITA")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME", "oxgenxBot")
# Don't Add style font
BOT_NAME = getenv("BOT_NAME", "JADUGAR x Mᴜsɪᴄ")
...
LOGGER_ID = int(getenv("LOGGER_ID", --1002097802249))

# ------------------------------------------------
GPT_API = getenv("GPT_API")
# Get this value from on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", 6908281996))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Diwanabot/Nobita",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/MRITYUY")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/NOBITA_H")
